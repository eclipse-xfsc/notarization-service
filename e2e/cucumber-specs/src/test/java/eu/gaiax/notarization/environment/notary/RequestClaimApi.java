...
public class RequestClaimApi {
    ...
    public ValidatableResponse claimNotarizationRequest(String requestId, String profileId) {
        var rawResponse = personManagement
                ...
                .when()
                .post(configuration.notarization().url().toString() + "/api/v1/profiles/{profileId}/requests/{notarizationRequestId}/claim")
                .then();
