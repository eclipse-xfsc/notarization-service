 ...
 */
package eu.gaiax.notarization.profile.domain.service
...
interface ProfileManagementService {
    fun list(index: Int,size: Int, sort: SortDirection): Uni<PagedView<Profile, NoFilter>>
    fun fetchProfile(id: String): Uni<Profile?>
    fun deleteProfile(identifier: String): Uni<Void>
    fun setProfile(identifier: String, profile: Profile): Uni<Void>
    fun listProfileIdentifiers(): Uni<List<String>>
    fun setDidInformation(identifier: String, didRequest: ProfileDidRequest): Uni<Void>
}
