 ...
 */
package eu.gaiax.notarization.profile.infrastructure.resource.ssiv1
...
@QuarkusTest
@Disabled
@TestProfile(NoSsiIssuanceV2Profile::class)
@QuarkusTestResource(MockOauth2ServerResource::class)
open class OnlySsiV1ClientTest {
    ...
    fun verifyRevocationInitializedAfterTriggeringInitialization() {
        assertThat(sut, equalTo(setOf(ApiVersion.V1)))
    }

    @Test
    fun hasCorrectV1Client() {
        assertThat(v1.isPresent, equalTo(true))
    }
