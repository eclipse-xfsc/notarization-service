 ...
 */
class DistributedIdentityDeserializer : JsonDeserializer<DistributedIdentity>() {
    @Throws(IOException::class, JacksonException::class)
    override fun deserialize(jp: JsonParser, dc: DeserializationContext): DistributedIdentity {
        return DistributedIdentity(jp.text)
    }
}
