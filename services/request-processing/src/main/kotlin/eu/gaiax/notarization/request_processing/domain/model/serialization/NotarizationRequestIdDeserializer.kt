 ...
 */
class NotarizationRequestIdDeserializer : JsonDeserializer<NotarizationRequestId>() {
    @Throws(IOException::class, JacksonException::class)
    override fun deserialize(jp: JsonParser, dc: DeserializationContext): NotarizationRequestId {
        return NotarizationRequestId(jp.text)
    }
}
