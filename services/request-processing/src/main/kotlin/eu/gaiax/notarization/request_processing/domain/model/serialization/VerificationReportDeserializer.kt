 ...
 */
class VerificationReportDeserializer : JsonDeserializer<VerificationReport>() {
    @Throws(IOException::class, JacksonException::class)
    override fun deserialize(jp: JsonParser, dc: DeserializationContext): VerificationReport {
        return VerificationReport(jp.text)
    }
}
