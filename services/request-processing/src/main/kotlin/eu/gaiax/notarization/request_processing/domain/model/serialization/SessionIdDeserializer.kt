 ...
 */
class SessionIdDeserializer : JsonDeserializer<SessionId>() {
    @Throws(IOException::class, JacksonException::class)
    override fun deserialize(jp: JsonParser, dc: DeserializationContext): SessionId {
        return SessionId(jp.text)
    }
}
