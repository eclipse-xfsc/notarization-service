...
class SelfSovereignIdentityIssuanceClientProvider {
    ...
    @Produces
    fun provideV1Client(): Optional<SsiIssuanceRestClient> {
        ...
        return if (issuanceV1ClientUrl.isEmpty) {
            ...
            Optional.of(
                RestClientCDIDelegateBuilder.createDelegate(
                    SsiIssuanceRestClient::class.java,
                    null,
                    clientV1Key
                )
            )
    ...
    @Produces
    fun provideV2Client(): Optional<Issuance2ApiAsync> {
