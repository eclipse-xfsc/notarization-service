 ...
 */
class ProfileIdDeserializer : JsonDeserializer<ProfileId>() {
    @Throws(IOException::class, JacksonException::class)
    override fun deserialize(jp: JsonParser, dc: DeserializationContext): ProfileId {
        return ProfileId(jp.text)
    }
}
